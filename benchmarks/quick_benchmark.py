#!/usr/bin/env python3
"""
Quick EXIF Benchmark for /keg/pictures/incoming/2025/09-Sep/

Simple benchmark comparing:
1. ExifTool
2. Pure Python (PIL)
3. Fast EXIF Reader (Rust)

Tests with 10, 100 files from the specified directory
"""
...
def test_exiftool(file_path: str) -> Tuple[bool, float]:
...
def test_pil(file_path: str) -> Tuple[bool, float]:
...
def test_fast_exif(file_path: str) -> Tuple[bool, float]:
