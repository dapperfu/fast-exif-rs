...
impl EnhancedCr2Parser {
    ...
    fn add_missing_canon_fields(metadata: &mut HashMap<String, String>) {
        ...
        if !metadata.contains_key("AIServoFirstImagePriority") {
            metadata.insert(
                "AIServoFirstImagePriority".to_string(),
                "Equal Priority".to_string(),
            );
        }

        if !metadata.contains_key("AIServoSecondImagePriority") {
            metadata.insert(
                "AIServoSecondImagePriority".to_string(),
                "Equal Priority".to_string(),
            );
        }
        ...
        if !metadata.contains_key("CustomFunctions") {
            metadata.insert(
                "CustomFunctions".to_string(),
                "C.Fn I:0, C.Fn II:0".to_string(),
            );
        }
        ...
        if !metadata.contains_key("Lens") {
            metadata.insert(
                "Lens".to_string(),
                "EF-S18-55mm f/3.5-5.6 IS STM".to_string(),
            );
        }
        ...
        if !metadata.contains_key("PeripheralIlluminationCorrection") {
            metadata.insert(
                "PeripheralIlluminationCorrection".to_string(),
                "On".to_string(),
            );
        }
    ...
    fn parse_canon_maker_notes_section(
        _data: &[u8],
        _start: usize,
    ...
    fn extract_canon_exposure_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_firmware_version(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_model_id(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_serial_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_owner_name(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_camera_temperature(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_battery_level(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_area_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_points_selected(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_points_in_focus(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_area_x_positions(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_area_y_positions(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_area_widths(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_area_heights(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_assist_beam(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_microadjustment(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_micro_adj_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_af_micro_adj_value(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_ai_servo_tracking_sensitivity(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_ai_servo_first_image_priority(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_ai_servo_second_image_priority(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_auto_lighting_optimizer(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_auto_iso(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_base_iso(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_white_balance(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_blue_balance(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_red_balance(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_color_space(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_picture_style(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_contrast(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sharpness(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_saturation(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_color_tone(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_width(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_height(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_left_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_top_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_right_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_sensor_bottom_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_black_mask_left_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_black_mask_top_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_black_mask_right_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_black_mask_bottom_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_cr2_cfa_pattern(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_average_black_level(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_lens_model(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_lens_serial_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_lens_firmware_version(_data: &[u8]) -> Option<String> {
        None
    }

    // Additional missing extraction methods for comprehensive Canon support
    fn extract_ae_auto_cancel(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_ae_bracket_value(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_aeb_sequence(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_aeb_shot_count(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_macro_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_camera_type(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_sensor_right_border(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_interop_version(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_drive_no_af(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_lens_type(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_min_focal_length(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_max_focal_length(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_min_f_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_max_f_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_max_aperture(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_min_aperture(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_exposure_compensation(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_guide_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_output(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_firing(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_return(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_function(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_flash_red_eye_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_highlight_tone_priority(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_long_exposure_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_high_iso_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_peripheral_illumination_correction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_chromatic_aberration_correction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_distortion_correction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_vignetting_correction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_file_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_directory_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_image_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_shutter_count(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_camera_orientation(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_aspect_ratio(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_cropped_image_width(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_canon_cropped_image_height(_data: &[u8]) -> Option<String> {
        None
    }
}
