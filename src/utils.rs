...
impl ExifUtils {
    ...
    pub fn extract_unix_timestamps(data: &[u8], metadata: &mut HashMap<String, String>) {
        ...
        for i in 0..data.len().saturating_sub(3) {
            ...
            let timestamp_le = u32::from_le_bytes([timestamp_bytes[0], timestamp_bytes[1], timestamp_bytes[2], timestamp_bytes[3]]);
            let timestamp_be = u32::from_be_bytes([timestamp_bytes[0], timestamp_bytes[1], timestamp_bytes[2], timestamp_bytes[3]]);
