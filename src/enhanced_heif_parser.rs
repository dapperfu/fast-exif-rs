...
impl EnhancedHeifParser {
        ...
        for i in 0..data.len().saturating_sub(8) {
            if &data[i..i + 4] == b"Exif" && i + 8 < data.len() {
                ...
                if tiff_start + 2 < data.len()
                    && (&data[tiff_start..tiff_start + 2] == b"II"
    ...
    fn find_exif_in_item_data_boxes(_data: &[u8]) -> Option<&[u8]> {
        None
    }
    fn find_exif_in_meta_structure(_data: &[u8]) -> Option<&[u8]> {
        None
    }

    fn extract_heif_version(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_compatible_brands(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_major_brand(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_heif_dimensions(_data: &[u8]) -> Option<(u32, u32)> {
        None
    }
    fn extract_bit_depth_luma(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_bit_depth_chroma(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_average_frame_rate(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_heif_color_space(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_color_primaries(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_transfer_characteristics(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_matrix_coefficients(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_blue_balance(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_red_balance(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_heif_compression(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_heif_encoding_process(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_heif_codec(_data: &[u8]) -> Option<String> {
        None
    }
    ...
    fn extract_creation_time(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_modification_time(_data: &[u8]) -> Option<String> {
        None
    }

    fn extract_af_area_mode(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_fine_tune(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_fine_tune_adj(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_fine_tune_adj_tele(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_fine_tune_index(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_info2_version(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_af_points_used(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_auto_focus(_data: &[u8]) -> Option<String> {
        None
    }

    fn extract_active_d_lighting(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_auto_distortion_control(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_vignette_control(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_high_iso_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_long_exposure_noise_reduction(_data: &[u8]) -> Option<String> {
        None
    }

    fn extract_picture_control(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_picture_control_name(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_picture_control_base(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_picture_control_adjust(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_picture_control_quick_adjust(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_picture_control_version(_data: &[u8]) -> Option<String> {
        None
    }
}
