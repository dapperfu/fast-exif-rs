...
impl EnhancedDngParser {
    ...
    fn add_missing_dng_fields(metadata: &mut HashMap<String, String>) {
        ...
        if !metadata.contains_key("CameraCalibration1") {
            metadata.insert(
                "CameraCalibration1".to_string(),
                "1 0 0 0 1 0 0 0 1".to_string(),
            );
        }

        if !metadata.contains_key("CameraCalibration2") {
            metadata.insert(
                "CameraCalibration2".to_string(),
                "1 0 0 0 1 0 0 0 1".to_string(),
            );
        }
    ...
    fn extract_dng_version_tag(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_dng_back_version(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_active_area(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_bits_per_sample(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_black_level(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_black_level_repeat_dim(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_white_level(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_default_crop_origin(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_default_crop_size(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_strip_byte_counts(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_strip_offsets(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_as_shot_neutral(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_color_matrix1(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_color_matrix2(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_camera_calibration1(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_camera_calibration2(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_calibration_illuminant1(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_calibration_illuminant2(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_forward_matrix1(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_forward_matrix2(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_profile_name(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_profile_copyright(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_profile_description(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_layout(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_pattern(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_pattern2(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_plane_color(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_repeat_pattern_dim(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_cfa_pattern_dimensions(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_processing_software(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_unique_camera_model(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_localized_camera_model(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_camera_serial_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_info(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_make(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_model(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_serial_number(_data: &[u8]) -> Option<String> {
        None
    }
    fn extract_lens_specification(_data: &[u8]) -> Option<String> {
        None
    }
}
